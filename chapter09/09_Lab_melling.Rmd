...
if a training observation is not a support vector, then its α i equals zero
...
- in the latter case we use gamma to specify a value of γ for the radial basis kernel (9.24).
